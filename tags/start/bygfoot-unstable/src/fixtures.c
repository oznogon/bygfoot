...
/* find out if the human player's team is involved
   in the fixture */
gboolean my_team_involved(fixture fix)
{
...
gboolean my_team_played(gint week_number)
{
    gint i;
...
gint get_first_fixture(gint type)
{
    gint i = 0;
...
gboolean exists_fixture(gint fixture_type, gint places)
{
    gint i;
...
/* get the next week from 'week' up- or downwards
   ...
   a certain league */
gint get_my_fixture_week(gint week_number, gint direction)
{
    gint i, j;
...
/* write one fixture */
void write_fixture(gint idx, gint team0, gint team1,
...
void write_round_robin_round(gint *ids, gint max, gint special,
			     gint type, gint week_number)
{
    gint i, k;
    gint pairs[max][2];
...
void write_round_robin(gint first_team_id,
		       gint last_team_id,
...
void write_pairings(gint *team_ids, gint max,
...
void write_fixtures_euro_cups(void)
{
    gint i;
    gint ids[32];
...
void write_fixtures_english_cups(void)
{
...
void write_season_fixtures(void)
{
    gint i;
...
void find_left_out(gint type, gint *left_out)
{
    gint i, k = 0;
...
gint get_winner_runner_up(gint type, gint winner)
{
    gint i;
...
gint winner_of_regular(fixture fix, gchar *buf, gint team_id)
{
    gint i;
...
void find_winners(gint first_type, gint leap, gint max, gint *winners)
{
    gint i = 0, k;
...
void update_fixtures_english_cups(gint type)
{
    gint i, j;
...
void update_champions_league_group(void)
{
    gint i, j;
    gint pairs[2];
...
void update_home_away_fixtures(gint first_type, gint max, gint new_type)
{
    gint i;
    gint winners[max];
    gint order[max];
...
void update_final(gint first_type, gint new_type)
{
    gint winners[2];
...
void update_uefa_supercup(void)
{
    gint i;
...
void update_charity_shield(void)
{
    gint i;
    gint idx = get_first_fixture(-1);
...
void update_relegation_second(void)
{
    gint i, j, k;
    gint pairs[2];
...
void update_relegation_first(void)
{
    gint i, j;
