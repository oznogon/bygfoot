...
create_team_selection (void)
{
  ...
  GtkWidget *vbox36;
  GtkWidget *hbox48;
  GtkWidget *radiobutton_country0;
  GSList *radiobutton_country0_group = NULL;
  GtkWidget *image46;
  GtkWidget *radiobutton_country1;
  GtkWidget *image47;
  GtkWidget *radiobutton_country2;
  GtkWidget *image52;
  ...
  GtkWidget *image50;
  GtkWidget *radiobutton_country5;
  GtkWidget *image54;
  GtkWidget *radiobutton_country6;
  GtkWidget *image56;
  GtkWidget *radiobutton_country7;
  GtkWidget *image57;
  GtkWidget *radiobutton_country8;
  GtkWidget *image58;
  GtkWidget *radiobutton_country10;
  GtkWidget *image60;
  ...
  team_selection = gtk_window_new (GTK_WINDOW_TOPLEVEL);
  gtk_container_set_border_width (GTK_CONTAINER (team_selection), 6);
  gtk_window_set_title (GTK_WINDOW (team_selection), _("Select team and country"));
  gtk_window_set_position (GTK_WINDOW (team_selection), GTK_WIN_POS_CENTER);
  gtk_window_set_default_size (GTK_WINDOW (team_selection), 500, 600);

  vbox2 = gtk_vbox_new (FALSE, 0);
  gtk_widget_show (vbox2);
  gtk_container_add (GTK_CONTAINER (team_selection), vbox2);
  ...
  team_selection_treeview = gtk_tree_view_new ();
  gtk_widget_show (team_selection_treeview);
  gtk_container_add (GTK_CONTAINER (scrolledwindow1), team_selection_treeview);
  gtk_container_set_border_width (GTK_CONTAINER (team_selection_treeview), 2);
  gtk_tree_view_set_rules_hint (GTK_TREE_VIEW (team_selection_treeview), TRUE);
  gtk_tree_view_set_reorderable (GTK_TREE_VIEW (team_selection_treeview), TRUE);
  ...
  gtk_box_pack_start (GTK_BOX (hbox44), vbox36, FALSE, TRUE, 0);

  hbox48 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox48);
  gtk_box_pack_start (GTK_BOX (vbox36), hbox48, TRUE, TRUE, 0);

  radiobutton_country0 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country0);
  gtk_box_pack_start (GTK_BOX (hbox48), radiobutton_country0, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country0, _("England"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country0), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country0));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (radiobutton_country0), TRUE);

  image46 = create_pixmap (team_selection, "flag_eng.png");
  gtk_widget_show (image46);
  gtk_container_add (GTK_CONTAINER (radiobutton_country0), image46);

  radiobutton_country1 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country1);
  gtk_box_pack_start (GTK_BOX (hbox48), radiobutton_country1, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country1, _("Germany"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country1), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country1));

  image47 = create_pixmap (team_selection, "flag_de.png");
  gtk_widget_show (image47);
  gtk_container_add (GTK_CONTAINER (radiobutton_country1), image47);

  radiobutton_country2 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country2);
  gtk_box_pack_start (GTK_BOX (hbox48), radiobutton_country2, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country2, _("Italy"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country2), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country2));

  image52 = create_pixmap (team_selection, "flag_it.png");
  gtk_widget_show (image52);
  gtk_container_add (GTK_CONTAINER (radiobutton_country2), image52);

  radiobutton_country3 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country3);
  gtk_box_pack_start (GTK_BOX (hbox48), radiobutton_country3, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country3, _("France"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country3), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country3));

  image51 = create_pixmap (team_selection, "flag_fr.png");
  ...
  radiobutton_country4 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country4);
  gtk_box_pack_start (GTK_BOX (hbox49), radiobutton_country4, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country4, _("Spain"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country4), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country4));

  image50 = create_pixmap (team_selection, "flag_es.png");
  gtk_widget_show (image50);
  gtk_container_add (GTK_CONTAINER (radiobutton_country4), image50);

  radiobutton_country5 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country5);
  gtk_box_pack_start (GTK_BOX (hbox49), radiobutton_country5, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country5, _("Romania"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country5), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country5));

  image54 = create_pixmap (team_selection, "flag_ro.png");
  gtk_widget_show (image54);
  gtk_container_add (GTK_CONTAINER (radiobutton_country5), image54);

  radiobutton_country6 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country6);
  gtk_box_pack_start (GTK_BOX (hbox49), radiobutton_country6, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country6, _("Brazil"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country6), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country6));

  image56 = create_pixmap (team_selection, "flag_br.png");
  gtk_widget_show (image56);
  gtk_container_add (GTK_CONTAINER (radiobutton_country6), image56);

  radiobutton_country7 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country7);
  gtk_box_pack_start (GTK_BOX (hbox49), radiobutton_country7, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country7, _("Poland"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country7), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country7));

  image57 = create_pixmap (team_selection, "flag_pl.png");
  ...
  radiobutton_country10 = gtk_radio_button_new (NULL);
  gtk_widget_show (radiobutton_country10);
  gtk_box_pack_start (GTK_BOX (hbox49), radiobutton_country10, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, radiobutton_country10, _("Chile"), NULL);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (radiobutton_country10), radiobutton_country0_group);
  radiobutton_country0_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (radiobutton_country10));

  image60 = create_pixmap (team_selection, "flag_cl.png");
  gtk_widget_show (image60);
  gtk_container_add (GTK_CONTAINER (radiobutton_country10), image60);
  ...
  g_signal_connect ((gpointer) team_selection, "delete_event",
                    ...
                    NULL);
  g_signal_connect ((gpointer) team_selection_treeview, "row_activated",
                    G_CALLBACK (on_team_selection_tv_row_activated),
                    NULL);
  g_signal_connect ((gpointer) radiobutton_country0, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  g_signal_connect ((gpointer) radiobutton_country1, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  g_signal_connect ((gpointer) radiobutton_country2, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  ...
  g_signal_connect ((gpointer) radiobutton_country4, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  g_signal_connect ((gpointer) radiobutton_country5, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  g_signal_connect ((gpointer) radiobutton_country6, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  ...
  g_signal_connect ((gpointer) radiobutton_country8, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  g_signal_connect ((gpointer) radiobutton_country10, "toggled",
                    G_CALLBACK (on_radiobutton_country_toggled),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT_NO_REF (team_selection, team_selection, "team_selection");
  GLADE_HOOKUP_OBJECT (team_selection, vbox2, "vbox2");
  GLADE_HOOKUP_OBJECT (team_selection, scrolledwindow1, "scrolledwindow1");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_treeview, "team_selection_treeview");
  GLADE_HOOKUP_OBJECT (team_selection, hseparator10, "hseparator10");
  GLADE_HOOKUP_OBJECT (team_selection, label4, "label4");
  GLADE_HOOKUP_OBJECT (team_selection, eventbox1, "eventbox1");
  GLADE_HOOKUP_OBJECT (team_selection, hbox2, "hbox2");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_radio1, "team_selection_radio1");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_radio2, "team_selection_radio2");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_radio3, "team_selection_radio3");
  GLADE_HOOKUP_OBJECT (team_selection, eventbox2, "eventbox2");
  GLADE_HOOKUP_OBJECT (team_selection, hbox50, "hbox50");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_cl, "radiobutton_cl");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_cwc, "radiobutton_cwc");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_uefa, "radiobutton_uefa");
  GLADE_HOOKUP_OBJECT (team_selection, hseparator11, "hseparator11");
  GLADE_HOOKUP_OBJECT (team_selection, vbox34, "vbox34");
  GLADE_HOOKUP_OBJECT (team_selection, label69, "label69");
  GLADE_HOOKUP_OBJECT (team_selection, hbox44, "hbox44");
  GLADE_HOOKUP_OBJECT (team_selection, vbox36, "vbox36");
  GLADE_HOOKUP_OBJECT (team_selection, hbox48, "hbox48");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_country0, "radiobutton_country0");
  GLADE_HOOKUP_OBJECT (team_selection, image46, "image46");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_country1, "radiobutton_country1");
  GLADE_HOOKUP_OBJECT (team_selection, image47, "image47");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_country2, "radiobutton_country2");
  ...
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_country5, "radiobutton_country5");
  GLADE_HOOKUP_OBJECT (team_selection, image54, "image54");
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_country6, "radiobutton_country6");
  ...
  GLADE_HOOKUP_OBJECT (team_selection, radiobutton_country10, "radiobutton_country10");
  GLADE_HOOKUP_OBJECT (team_selection, image60, "image60");
  ...
  GLADE_HOOKUP_OBJECT (team_selection, hbox45, "hbox45");
  GLADE_HOOKUP_OBJECT (team_selection, image45, "image45");
  GLADE_HOOKUP_OBJECT (team_selection, label70, "label70");
  GLADE_HOOKUP_OBJECT (team_selection, hseparator12, "hseparator12");
  GLADE_HOOKUP_OBJECT (team_selection, hbox46, "hbox46");
  GLADE_HOOKUP_OBJECT (team_selection, vbox35, "vbox35");
  GLADE_HOOKUP_OBJECT (team_selection, checkbutton_no_def, "checkbutton_no_def");
  GLADE_HOOKUP_OBJECT (team_selection, checkbutton_only_names, "checkbutton_only_names");
  GLADE_HOOKUP_OBJECT (team_selection, checkbutton_load_my_team, "checkbutton_load_my_team");
  GLADE_HOOKUP_OBJECT (team_selection, vseparator18, "vseparator18");
  GLADE_HOOKUP_OBJECT (team_selection, button_start_editor, "button_start_editor");
  GLADE_HOOKUP_OBJECT (team_selection, alignment15, "alignment15");
  GLADE_HOOKUP_OBJECT (team_selection, hbox47, "hbox47");
  GLADE_HOOKUP_OBJECT (team_selection, image55, "image55");
  GLADE_HOOKUP_OBJECT (team_selection, label71, "label71");
  GLADE_HOOKUP_OBJECT (team_selection, hbox3, "hbox3");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_ok, "team_selection_ok");
  GLADE_HOOKUP_OBJECT (team_selection, alignment1, "alignment1");
  GLADE_HOOKUP_OBJECT (team_selection, hbox4, "hbox4");
  GLADE_HOOKUP_OBJECT (team_selection, image2, "image2");
  GLADE_HOOKUP_OBJECT (team_selection, label1, "label1");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_cancel, "team_selection_cancel");
  GLADE_HOOKUP_OBJECT (team_selection, alignment2, "alignment2");
  GLADE_HOOKUP_OBJECT (team_selection, hbox5, "hbox5");
  GLADE_HOOKUP_OBJECT (team_selection, image3, "image3");
  GLADE_HOOKUP_OBJECT (team_selection, label2, "label2");
  GLADE_HOOKUP_OBJECT (team_selection, team_selection_load, "team_selection_load");
  GLADE_HOOKUP_OBJECT (team_selection, alignment3, "alignment3");
  GLADE_HOOKUP_OBJECT (team_selection, hbox6, "hbox6");
  GLADE_HOOKUP_OBJECT (team_selection, image4, "image4");
  GLADE_HOOKUP_OBJECT (team_selection, label5, "label5");
  GLADE_HOOKUP_OBJECT_NO_REF (team_selection, tooltips, "tooltips");

  gtk_window_add_accel_group (GTK_WINDOW (team_selection), accel_group);
