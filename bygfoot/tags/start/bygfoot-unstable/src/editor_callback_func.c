...
void set_spinbutton_values(void)
{
...
void write_team_to_screen(void)
{
    gint i;
...
void save_defs(const gchar *def_file)
{
    gint i, skill, talent;
    gchar buf[BUF_SIZE_SMALL];
...
gboolean callback_save_defs(void)
{
    gchar buf[BUF_SIZE_SMALL];
    GtkWidget *entry_team = 
	lookup_widget(main_window, "entry_team");
